...
void  *OSMboxPend (OS_EVENT *pevent, INT16U timeout, INT8U *err) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
INT8U  OSMboxPost (OS_EVENT *pevent, void *msg) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
INT8U  OSMboxPostOpt (OS_EVENT *pevent, void *msg, INT8U opt) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
INT8U  OSMboxQuery (OS_EVENT *pevent, OS_MBOX_DATA *pdata) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
