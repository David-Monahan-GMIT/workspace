...
OS_MEM  *OSMemCreate (void *addr, INT32U nblks, INT32U blksize, INT8U *err) KCREENTRANT
{
...
void  *OSMemGet (OS_MEM *pmem, INT8U *err) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                           /* Allocate storage for CPU status register      */
    OS_CPU_SR  cpu_sr;
#endif    
...
INT8U  OSMemPut (OS_MEM  *pmem, void *pblk) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
INT8U  OSMemQuery (OS_MEM *pmem, OS_MEM_DATA *pdata) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
void  OS_MemInit (void) KCREENTRANT
{
