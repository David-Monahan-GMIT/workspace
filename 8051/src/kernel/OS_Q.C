...
#if OS_Q_FLUSH_EN > 0
INT8U  OSQFlush (OS_EVENT *pevent) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                           /* Allocate storage for CPU status register      */
    OS_CPU_SR  cpu_sr;
#endif    
...
void  *OSQPend (OS_EVENT *pevent, INT16U timeout, INT8U *err) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
#if OS_Q_POST_EN > 0
INT8U  OSQPost (OS_EVENT *pevent, void *msg) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
#if OS_Q_QUERY_EN > 0
INT8U  OSQQuery (OS_EVENT *pevent, OS_Q_DATA *pdata) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
    OS_CPU_SR  cpu_sr;
#endif    
...
void  OS_QInit (void) KCREENTRANT
{
#if OS_MAX_QS == 1
